<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable" id="<?php echo uniqid(); ?>">
	<thead>
		...
		<tr>
			<?php foreach($columns as $column){?>
				<th>
					<input type="text" name="<?php echo $column->field_name; ?>" placeholder="<?php echo $this->l('list_search').' '.$column->display_as; ?>" class="get_action_toogle_search search_<?php echo $column->field_name; ?>" style="width: 100%;"/>
			...
			<td class='actions'>
				...
				?>
						<a href="<?php echo $action_url; ?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
							...
							<i class="fa fa-bell-o fa_custom" aria-hidden="true" style="color: gray;"></i>
				...
				<?php if(!$unset_read){?>
					<a href="<?php echo $row->read_url?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
						...
						<i class="fa fa-search fa_custom" aria-hidden="true" style="color: blue;"></i>
				...
				<?php if(!$unset_edit){?>
					<a href="<?php echo $row->edit_url?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
						...
						<i class="fa fa-pencil fa_custom" aria-hidden="true" style="color: #9300ff;"></i>
				...
				<?php if(!$unset_delete){?>
					<a onclick = "javascript: return delete_row('<?php echo $row->delete_url?>', '<?php echo $num_row?>')"
						...
						<i class="fa fa-minus-circle fa_custom" aria-hidden="true" style="color: red;"></i>
